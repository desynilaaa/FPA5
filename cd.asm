...
int main(int argc, char *argv[]){
  ...
  1d:	e8 f0 02 00 00       	call   312 <chdir>
...
int main(int argc, char *argv[]){
  ...
  45:	68 3c 07 00 00       	push   $0x73c
  4a:	6a 01                	push   $0x1
  4c:	e8 9f 03 00 00       	call   3f0 <printf>
  51:	83 c4 10             	add    $0x10,%esp
  54:	eb d3                	jmp    29 <main+0x29>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
  }while((x /= base) != 0);
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 04 0a 00 00       	mov    %eax,0xa04
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 04 0a 00 00       	mov    %eax,0xa04
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 67f:	76 3f                	jbe    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	39 05 04 0a 00 00    	cmp    %eax,0xa04
 ...
 6a6:	e8 e5 fe ff ff       	call   590 <free>
  return freep;
 6ab:	8b 15 04 0a 00 00    	mov    0xa04,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 04 0a 00 00    	mov    %edx,0xa04
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 04 0a 00 00 08 	movl   $0xa08,0xa04
 6ed:	0a 00 00 
 6f0:	c7 05 08 0a 00 00 08 	movl   $0xa08,0xa08
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 08 0a 00 00       	mov    $0xa08,%eax
 6ff:	c7 05 0c 0a 00 00 00 	movl   $0x0,0xa0c
 706:	00 00 00 
