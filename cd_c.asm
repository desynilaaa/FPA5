...
int main(int argc, char *argv[]){
  ...
  32:	e8 eb 02 00 00       	call   322 <chdir>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 18                	js     56 <main+0x56>
...
int main(int argc, char *argv[]){
  ...
  5a:	68 8c 07 00 00       	push   $0x78c
  5f:	6a 01                	push   $0x1
  61:	e8 9a 03 00 00       	call   400 <printf>
  66:	83 c4 10             	add    $0x10,%esp
  69:	eb d3                	jmp    3e <main+0x3e>
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 b0 07 00 00       	mov    $0x7b0,%eax
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 58 0a 00 00       	mov    %eax,0xa58
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	39 05 58 0a 00 00    	cmp    %eax,0xa58
 ...
 6b6:	e8 e5 fe ff ff       	call   5a0 <free>
  return freep;
 6bb:	8b 15 58 0a 00 00    	mov    0xa58,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 6fd:	0a 00 00 
 700:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 5c 0a 00 00       	mov    $0xa5c,%eax
 70f:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 716:	00 00 00 
