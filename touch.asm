...
int main(int argc, char *argv[]){
  ...
  1c:	68 01 02 00 00       	push   $0x201
  21:	ff 70 04             	pushl  0x4(%eax)
  24:	e8 c9 02 00 00       	call   2f2 <open>
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	78 21                	js     51 <main+0x51>
  ...
  33:	50                   	push   %eax
  34:	e8 a1 02 00 00       	call   2da <close>

  exit();
  39:	e8 74 02 00 00       	call   2b2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 7c 07 00 00 	movzbl 0x77c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 74 07 00 00       	mov    $0x774,%eax
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 14 0a 00 00       	mov    %eax,0xa14
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	39 05 14 0a 00 00    	cmp    %eax,0xa14
 ...
 6b6:	e8 e5 fe ff ff       	call   5a0 <free>
  return freep;
 6bb:	8b 15 14 0a 00 00    	mov    0xa14,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 14 0a 00 00    	mov    %edx,0xa14
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 6fd:	0a 00 00 
 700:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 18 0a 00 00       	mov    $0xa18,%eax
