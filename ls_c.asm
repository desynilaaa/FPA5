...
int main(int argc, char *argv[]) {
  ...
  1e:	68 2b 0a 00 00       	push   $0xa2b
  23:	6a 01                	push   $0x1
  25:	e8 96 06 00 00       	call   6c0 <printf>
  if(argc < 2){
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	83 fe 01             	cmp    $0x1,%esi
  30:	7e 20                	jle    52 <main+0x52>
  ...
  exit();
  4d:	e8 20 05 00 00       	call   572 <exit>
...
int main(int argc, char *argv[]) {
  ...
  55:	68 44 0a 00 00       	push   $0xa44
  5a:	e8 b1 00 00 00       	call   110 <ls>
    exit();
  5f:	e8 0e 05 00 00       	call   572 <exit>
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
...
char* fmtname(char *path){
  ...
  7b:	53                   	push   %ebx
  7c:	e8 2f 03 00 00       	call   3b0 <strlen>
  81:	83 c4 10             	add    $0x10,%esp
  84:	01 d8                	add    %ebx,%eax
  86:	73 0f                	jae    97 <fmtname+0x27>
  88:	eb 12                	jmp    9c <fmtname+0x2c>
  ...
  ab:	83 f8 0d             	cmp    $0xd,%eax
  ae:	77 4a                	ja     fa <fmtname+0x8a>
    return p;
  }
  memmove(buf, p, strlen(p));
  b0:	83 ec 0c             	sub    $0xc,%esp
  b3:	53                   	push   %ebx
  b4:	e8 f7 02 00 00       	call   3b0 <strlen>
  b9:	83 c4 0c             	add    $0xc,%esp
  bc:	50                   	push   %eax
  bd:	53                   	push   %ebx
  be:	68 5c 0d 00 00       	push   $0xd5c
  c3:	e8 78 04 00 00       	call   540 <memmove>
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  c8:	89 1c 24             	mov    %ebx,(%esp)
  cb:	e8 e0 02 00 00       	call   3b0 <strlen>
  d0:	89 1c 24             	mov    %ebx,(%esp)
  d3:	89 c6                	mov    %eax,%esi
  return buf;
  d5:	bb 5c 0d 00 00       	mov    $0xd5c,%ebx
  p++;
  if(strlen(p) >= DIRSIZ){
    return p;
  }
  memmove(buf, p, strlen(p));
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  da:	e8 d1 02 00 00       	call   3b0 <strlen>
  df:	ba 0e 00 00 00       	mov    $0xe,%edx
  e4:	83 c4 0c             	add    $0xc,%esp
  e7:	05 5c 0d 00 00       	add    $0xd5c,%eax
  ec:	29 f2                	sub    %esi,%edx
  ee:	52                   	push   %edx
  ef:	6a 20                	push   $0x20
  f1:	50                   	push   %eax
  f2:	e8 e9 02 00 00       	call   3e0 <memset>
  return buf;
...
void ls(char *path) {
 ...
 11f:	6a 00                	push   $0x0
 121:	57                   	push   %edi
 122:	e8 8b 04 00 00       	call   5b2 <open>
 127:	83 c4 10             	add    $0x10,%esp
 12a:	85 c0                	test   %eax,%eax
 12c:	0f 88 86 01 00 00    	js     2b8 <ls+0x1a8>
    printf(2, "ls: cannot open %s\n", path);
    return;
  }

  if(fstat(fd, &st) < 0){
 132:	8d b5 d4 fd ff ff    	lea    -0x22c(%ebp),%esi
 138:	83 ec 08             	sub    $0x8,%esp
 13b:	89 c3                	mov    %eax,%ebx
 13d:	56                   	push   %esi
 13e:	50                   	push   %eax
 13f:	e8 86 04 00 00       	call   5ca <fstat>
 144:	83 c4 10             	add    $0x10,%esp
 147:	85 c0                	test   %eax,%eax
 149:	0f 88 a1 01 00 00    	js     2f0 <ls+0x1e0>
 ...
 15a:	74 54                	je     1b0 <ls+0xa0>
 15c:	66 83 f8 02          	cmp    $0x2,%ax
 160:	75 39                	jne    19b <ls+0x8b>
  case T_FILE:
    printf(1, "%s %d %d %d %s\n", fmtname(path), st.type, st.ino, st.size, path);
 162:	8b 95 e4 fd ff ff    	mov    -0x21c(%ebp),%edx
 168:	83 ec 0c             	sub    $0xc,%esp
 16b:	8b b5 dc fd ff ff    	mov    -0x224(%ebp),%esi
 171:	57                   	push   %edi
 172:	89 95 b4 fd ff ff    	mov    %edx,-0x24c(%ebp)
 178:	e8 f3 fe ff ff       	call   70 <fmtname>
 17d:	8b 95 b4 fd ff ff    	mov    -0x24c(%ebp),%edx
 ...
 19e:	53                   	push   %ebx
 19f:	e8 f6 03 00 00       	call   59a <close>
 ...
 1b3:	57                   	push   %edi
 1b4:	e8 f7 01 00 00       	call   3b0 <strlen>
 1b9:	83 c0 10             	add    $0x10,%eax
 1bc:	83 c4 10             	add    $0x10,%esp
 1bf:	3d 00 02 00 00       	cmp    $0x200,%eax
 1c4:	0f 87 0e 01 00 00    	ja     2d8 <ls+0x1c8>
 ...
 1dd:	e8 ce 01 00 00       	call   3b0 <strlen>
 1e2:	8d 0c 07             	lea    (%edi,%eax,1),%ecx
    *p++ = '/';
 1e5:	8d 44 07 01          	lea    0x1(%edi,%eax,1),%eax
 ...
 1e9:	83 c4 10             	add    $0x10,%esp
    ...
    strcpy(buf, path);
    p = buf+strlen(buf);
 1ec:	89 8d a8 fd ff ff    	mov    %ecx,-0x258(%ebp)
    *p++ = '/';
 1f2:	89 85 a4 fd ff ff    	mov    %eax,-0x25c(%ebp)
 1f8:	c6 01 2f             	movb   $0x2f,(%ecx)
 1fb:	90                   	nop
 1fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 200:	8d 85 c4 fd ff ff    	lea    -0x23c(%ebp),%eax
 206:	83 ec 04             	sub    $0x4,%esp
 209:	6a 10                	push   $0x10
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 78 03 00 00       	call   58a <read>
 212:	83 c4 10             	add    $0x10,%esp
 215:	83 f8 10             	cmp    $0x10,%eax
 218:	75 81                	jne    19b <ls+0x8b>
      if(de.inum == 0)
 21a:	66 83 bd c4 fd ff ff 	cmpw   $0x0,-0x23c(%ebp)
 221:	00 
 222:	74 dc                	je     200 <ls+0xf0>
        continue;
      memmove(p, de.name, DIRSIZ);
 224:	8d 85 c6 fd ff ff    	lea    -0x23a(%ebp),%eax
 22a:	83 ec 04             	sub    $0x4,%esp
 22d:	6a 0e                	push   $0xe
 22f:	50                   	push   %eax
 230:	ff b5 a4 fd ff ff    	pushl  -0x25c(%ebp)
 236:	e8 05 03 00 00       	call   540 <memmove>
      p[DIRSIZ] = 0;
 23b:	8b 85 a8 fd ff ff    	mov    -0x258(%ebp),%eax
 241:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
      if(stat(buf, &st) < 0){
 245:	58                   	pop    %eax
 246:	5a                   	pop    %edx
 247:	56                   	push   %esi
 248:	57                   	push   %edi
 249:	e8 62 02 00 00       	call   4b0 <stat>
 24e:	83 c4 10             	add    $0x10,%esp
 251:	85 c0                	test   %eax,%eax
 253:	0f 88 b7 00 00 00    	js     310 <ls+0x200>
        printf(1, "ls: cannot stat %s\n", buf);
        continue;
      }
      printf(1, "%s %d %d %d %s\n", fmtname(buf), st.type, st.ino, st.size, buf);
 259:	0f bf 85 d4 fd ff ff 	movswl -0x22c(%ebp),%eax
 260:	8b 8d e4 fd ff ff    	mov    -0x21c(%ebp),%ecx
 266:	83 ec 0c             	sub    $0xc,%esp
 269:	8b 95 dc fd ff ff    	mov    -0x224(%ebp),%edx
 26f:	57                   	push   %edi
 270:	89 8d ac fd ff ff    	mov    %ecx,-0x254(%ebp)
 276:	89 95 b0 fd ff ff    	mov    %edx,-0x250(%ebp)
 27c:	89 85 b4 fd ff ff    	mov    %eax,-0x24c(%ebp)
 282:	e8 e9 fd ff ff       	call   70 <fmtname>
 287:	8b 8d ac fd ff ff    	mov    -0x254(%ebp),%ecx
 28d:	8b 95 b0 fd ff ff    	mov    -0x250(%ebp),%edx
 293:	83 c4 0c             	add    $0xc,%esp
 296:	57                   	push   %edi
 297:	51                   	push   %ecx
 298:	52                   	push   %edx
 299:	ff b5 b4 fd ff ff    	pushl  -0x24c(%ebp)
 29f:	50                   	push   %eax
 2a0:	68 08 0a 00 00       	push   $0xa08
 2a5:	6a 01                	push   $0x1
 2a7:	e8 14 04 00 00       	call   6c0 <printf>
 2ac:	83 c4 20             	add    $0x20,%esp
 2af:	e9 4c ff ff ff       	jmp    200 <ls+0xf0>
 ...
 2bb:	57                   	push   %edi
 2bc:	68 e0 09 00 00       	push   $0x9e0
 2c1:	6a 02                	push   $0x2
 2c3:	e8 f8 03 00 00       	call   6c0 <printf>
    return;
 ...
 2db:	68 18 0a 00 00       	push   $0xa18
 2e0:	6a 01                	push   $0x1
 2e2:	e8 d9 03 00 00       	call   6c0 <printf>
      break;
 2e7:	83 c4 10             	add    $0x10,%esp
 2ea:	e9 ac fe ff ff       	jmp    19b <ls+0x8b>
 2ef:	90                   	nop
    printf(2, "ls: cannot open %s\n", path);
    return;
  }
 ...
 2f3:	57                   	push   %edi
 2f4:	68 f4 09 00 00       	push   $0x9f4
 2f9:	6a 02                	push   $0x2
 2fb:	e8 c0 03 00 00       	call   6c0 <printf>
    close(fd);
 300:	89 1c 24             	mov    %ebx,(%esp)
 303:	e8 92 02 00 00       	call   59a <close>
    return;
 308:	83 c4 10             	add    $0x10,%esp
 30b:	e9 97 fe ff ff       	jmp    1a7 <ls+0x97>
      if(de.inum == 0)
        continue;
      memmove(p, de.name, DIRSIZ);
      p[DIRSIZ] = 0;
 ...
 313:	57                   	push   %edi
 314:	68 f4 09 00 00       	push   $0x9f4
 319:	6a 01                	push   $0x1
 31b:	e8 a0 03 00 00       	call   6c0 <printf>
        continue;
 320:	83 c4 10             	add    $0x10,%esp
 323:	e9 d8 fe ff ff       	jmp    200 <ls+0xf0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 65f:	f7 f6                	div    %esi
 661:	0f b6 92 50 0a 00 00 	movzbl 0xa50(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 7d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 7db:	b8 46 0a 00 00       	mov    $0xa46,%eax
...
free(void *ap)
{
 ...
 861:	a1 6c 0d 00 00       	mov    0xd6c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8b9:	a3 6c 0d 00 00       	mov    %eax,0xd6c
}
 8be:	5b                   	pop    %ebx
 8bf:	5e                   	pop    %esi
 8c0:	5f                   	pop    %edi
 ...
 8da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 8dd:	a3 6c 0d 00 00       	mov    %eax,0xd6c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 8f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8fc:	8b 15 6c 0d 00 00    	mov    0xd6c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 94f:	76 3f                	jbe    990 <malloc+0xa0>
    ...
    if(p == freep)
 951:	39 05 6c 0d 00 00    	cmp    %eax,0xd6c
 ...
 976:	e8 e5 fe ff ff       	call   860 <free>
  return freep;
 97b:	8b 15 6c 0d 00 00    	mov    0xd6c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 99c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 99f:	89 15 6c 0d 00 00    	mov    %edx,0xd6c
      return (void*)(p + 1);
 ...
 9b4:	eb e9                	jmp    99f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9b6:	c7 05 6c 0d 00 00 70 	movl   $0xd70,0xd6c
 9bd:	0d 00 00 
 9c0:	c7 05 70 0d 00 00 70 	movl   $0xd70,0xd70
 9c7:	0d 00 00 
    base.s.size = 0;
 9ca:	b8 70 0d 00 00       	mov    $0xd70,%eax
 9cf:	c7 05 74 0d 00 00 00 	movl   $0x0,0xd74
 9d6:	00 00 00 
